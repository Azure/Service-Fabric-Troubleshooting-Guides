...
7. Using the Azure Portal, navigate to your Virtual Machine Scale Set resource and add a new VM Extension. Update the URL to your container and DSC script. For detailed instructions on modifying VMSS resources, see [Alternatives to resources.azure.com](./azure-resource-explorer-alternatives.md).
