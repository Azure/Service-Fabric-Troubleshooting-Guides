...
> a. If the new certificate is in the **same Key Vault** as the Primary, add **"certificateUrl"** and **"certificateStore"** store to the existing array of **"vaultCertificates"** as shown below:
