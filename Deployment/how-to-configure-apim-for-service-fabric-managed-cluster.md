...
- Script from [Azure-Samples/service-fabric-scripts](https://github.com/Azure-Samples/service-fabric-scripts/tree/master/Scripts)

**Download and Usage**:

```powershell
# Download script if not present
$scriptUrl = "https://raw.githubusercontent.com/Azure-Samples/service-fabric-scripts/master/Scripts/ServiceFabric/SF-Managed-Cluster/sf-managed-connect.ps1"
