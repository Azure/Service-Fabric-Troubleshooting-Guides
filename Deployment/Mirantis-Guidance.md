...
This guide is for all SF customers using “with container” VM images (list of effected VM images) and the migration scenarios broadly categorizes customers’ use-cases into a) Running containerized workloads on SF b) Running non-containerized workloads on SF. 
