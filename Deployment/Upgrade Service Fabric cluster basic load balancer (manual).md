...
This document outlines the manual process to upgrade from Basic to Standard SKU with no down time, as part of the Load Balancer Deprecation Migration guide detailed [here](./Upgrade Service Fabric cluster basic load balancer.md).
