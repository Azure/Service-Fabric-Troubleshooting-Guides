...
graph TD;
    ...
    PickReplacementOption --> GalleryImage[OS Image from Azure Gallery]
    ...
    GalleryImage --> NewImageIsPrepped3[Find and use Azure Marketplace VM images with Azure PowerShell]
    ...
    HostingPrepImagePrimary --> HostingPrepImagePrimaryStep1[Create new VMSS based on prepped Image] --> HostingPrepImagePrimaryStep2[Install container runtime] --> HostingPrepImagePrimaryStep3[OS SKU upgrade]
