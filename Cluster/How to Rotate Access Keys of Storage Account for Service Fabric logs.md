...
Best practice is to provision and manage Service Fabric clusters using ARM templates. This guide describes the steps to rotate Storage Account Keys using ARM templates. If you are not using ARM templates to provision and manage Service Fabric clusters, you can use the Azure Portal to modify the Service Fabric resource to rotate Storage Account Keys. See [Managing Azure Resources](../Deployment/managing-azure-resources.md) for detailed instructions.
...
3. Using ARM Template method or method from [Managing Azure Resources](../Deployment/managing-azure-resources.md), modify each node type to rotate storage account key.
   1. Setting inactive storage account key.
   2. Setting active storage account key.
...
1. Using [Resource Explorer](https://portal.azure.com/#view/Microsoft_Azure_Resources/ResourceManagerBlade/~/resourceexplorer) in the Azure Portal, navigate to the Service Fabric cluster:
